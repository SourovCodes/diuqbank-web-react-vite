  ...
  if (isPending)
    return (
      <div className="container mx-auto flex-1 px-4 py-16">
        <div className="mx-auto max-w-6xl rounded-lg border border-dashed border-gray-200 py-14 text-center text-sm text-gray-500 dark:border-gray-800 dark:text-gray-400">
          Loading question...
        </div>
      </div>
    );
